...
const SubmissionSuccess = () => {
  ...
  const onCheckStatus = () => {
    router.replace(`/complaints/check-status?ticketNumber=${id}`);
    ...
    <div className="min-h-[500px] bg-white flex items-center justify-center p-4 lg:rounded-[28px] shadow-sm">
      <div className="w-full max-w-md">
        ...
        <p className="text-center mb-8">
          ...
          <span className="text-[#59285F] font-medium">{id}</span> has been
          successfully submitted. You should expect notification in your email
          and text messages with the next way forward.
        </p>
